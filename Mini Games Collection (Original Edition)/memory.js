...
//简单版的记忆翻牌，4*4，需要8组，8个不同的符号
const cardSymbols = ['♥', '♦', '♣', '♠', '★', '☆', '●', '○'];

// 获取DOM元素
const memoryBoard = document.getElementById('memory-board');
const memoryAttemptsElement = document.getElementById('memory-attempts');
const memoryResetBtn = document.getElementById('memory-reset');
const memoryGameOverElement = document.getElementById('memory-game-over');
const memoryFinalAttemptsElement = document.getElementById('memory-final-attempts');
